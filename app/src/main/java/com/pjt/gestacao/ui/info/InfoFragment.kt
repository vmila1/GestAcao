...
class InfoFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return ComposeView(requireContext()).apply {
            setContent {
                // Usamos o tema que você copiou para garantir que a fonte e as cores funcionem
                GestAcaoTheme { // Se o seu tema tiver outro nome, ajuste aqui
                    TelaGestante()
                }
            }
        }
...
// COPIE E COLE AS FUNÇÕES COMPOSABLE ABAIXO, NO MESMO ARQUIVO
