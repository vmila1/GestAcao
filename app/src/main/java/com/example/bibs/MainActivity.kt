...
import com.example.bibs.ui.theme.BibsTheme
...
fun TelaGestante() {
    ...
    Column(
        ...
        Card(
            ...
            // ########## CARD DO ABACAXI COM ALINHAMENTO AJUSTADO ##########
            Column(
                modifier = Modifier.padding(16.dp).fillMaxWidth(),
                // Alinhamento da coluna alterado para o início (esquerda)
                horizontalAlignment = Alignment.Start
            ) {
                Text(
                    text = "Tamanho de",
                    // Estilo alterado para bodyLarge para igualar o tamanho do texto de baixo
                    style = MaterialTheme.typography.bodyLarge
                )
                Spacer(modifier = Modifier.height(8.dp))
                Image(
                    ...
                    // Alinhamento individual para centralizar a imagem na coluna
                ...
                Text(
                    ...
                    style = MaterialTheme.typography.bodyLarge,
                    // Alinhamento individual para centralizar o texto
                ...
                Column(modifier = Modifier.fillMaxWidth()) {
                    Row(verticalAlignment = Alignment.CenterVertically) {
                        Column(Modifier.weight(1f)) {
                            DevelopmentTableRow("1 a 4", "1 mês", Color(0xFFDDEBD9))
                            DevelopmentTableRow("5 a 8", "2 meses", Color(0xFFDDEBD9))
                            DevelopmentTableRow("9 a 12", "3 meses", Color(0xFFDDEBD9))
                        }
                    ...
                    Row(verticalAlignment = Alignment.CenterVertically) {
                        Column(Modifier.weight(1f)) {
                            DevelopmentTableRow("13 a 16", "4 meses", Color(0xFFDDEBD9))
                            DevelopmentTableRow("17 a 21", "5 meses", Color(0xFFDDEBD9))
                            DevelopmentTableRow("22 a 26", "6 meses", Color(0xFFDDEBD9))
                        }
